  ...
  const questions=[
    {
      ...
      "answer": "First complete the login and sign-up process. It will take you to the homepage where all the available movies are displayed."
    },
    {
    ...
    {
      "question": "Is it possible to choose specific seats during the booking process?",
      "answer": "Yes, a detailed seating plot will be provided to the user where all the available seats are displayed. The already booked seats will be frozen and cannot be selected."
    },
    {
      "question": "Are there any additional fees or charges associated with online ticket bookings?",
      "answer": "No additional fees are imposed on the users; ours is a user-friendly website."
    },
    {
      "question": "How do I receive my movie tickets after booking online?",
      "answer": "A detailed email will be sent to the user's email. Alternatively, the user can check the status on the website by logging in with the credentials."
    },
    {
    ...
    {
      "question": "Do you offer discounts or promotional codes for movie tickets?",
    ...
    },
    {
      ...
      "answer": "Currently, COVID-19 is not in existence. But we would provide sanitizers and masks' coupons along with the e-ticket to the customers."
    },
    {
    ...
    },
    {
      ...
      "answer": "Yes, a detailed seating matrix is shown from which the required seats can be selected."
    },
    {
    ...
    {
      "question": "Can I book tickets for future dates or only for the current day?",
      "answer": "Tickets for the next days also be booked."
    },
    {
      "question": "Do you have a mobile app, and how is it different from the website?",
      "answer": "Only the website is available; a mobile app will be released soon."
    }
  ]
  return (
